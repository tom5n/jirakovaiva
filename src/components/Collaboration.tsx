...
const Collaboration = () => {
  // Zjistím, zda jsme na stránce /farmasi
  ...
  return (
    <>
      ...
      <section id="collaboration" className={`section-padding ${isFarmasiPage ? 'bg-[#FFD1C1]' : 'bg-[#F3E8E2]'} relative`}>
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className={`${isFarmasiPage ? 'text-4xl md:text-5xl lg:text-6xl font-[\'Dancing_Script\']' : 'section-title'} mx-auto reveal inline-block text-[#21435F]`}>
              Spolupráce se mnou
            </h2>
          ...
          <div className="flex justify-center reveal reveal-delay-400">
            {isFarmasiPage ? (
              <Link to="/spoluprace" className="bg-[#21435F] text-white hover:bg-[#21435F]/90 transition-colors duration-300 flex items-center px-10 py-4 text-lg rounded-full group">
                Začít spolupráci

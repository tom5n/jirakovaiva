...
const InstagramFeed = () => {
  ...
  return (
    <section id="instagram" className="pt-24 pb-16 bg-[#FFD1C1]">
      <div className="container max-w-[90rem] mx-auto">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-['Dancing_Script'] mx-auto reveal block text-[#21435F] text-center mb-16">

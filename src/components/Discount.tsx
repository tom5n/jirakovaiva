...
const Discount = () => {
  ...
  return (
    <section id="discount" className="section-padding bg-[#FFD1C1]">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className={`${isFarmasiPage ? 'text-4xl md:text-5xl lg:text-6xl font-[\'Dancing_Script\']' : 'section-title'} reveal text-[#21435F]`}>

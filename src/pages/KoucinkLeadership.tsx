...
const KoucinkLeadership = () => {
  ...
  const features = [
    "Komplexní leadership program na míru",
    "Workshopy a školení pro vedení",
    "Dlouhodobá spolupráce s firmou",
    "Rozvoj leadership dovedností",
    "Budování silného týmu a kultury",
    "Strategické plánování a vedení změn",
  ];

  const whatIsIncluded = [
    "Úvodní analýza potřeb firmy",
    "Individuální a skupinové sezení",
    "Firemní workshopy a školení",
    "Materiály a zdroje pro leadership",
    "Průběžná podpora a konzultace",
  ...
  return (
    <>
      <SeoHead
        title="Pro firmy - Leadership | Ivana Jiráková"
        description="Komplexní leadership program pro firmy a organizace. Rozvoj leadership dovedností a budování silného týmu."
        url="https://www.jirakovaiva.cz/koucink/leadership"
      />
          ...
          <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="order-1 md:order-1">
               <h2 className="reveal reveal-delay-200 text-4xl md:text-5xl lg:text-6xl text-[#21435F] font-['Montserrat'] font-light mb-6">
                 Pro firmy - <strong className="font-medium">Leadership</strong>
               </h2>
              <p className="reveal reveal-delay-400 text-xl md:text-2xl text-gray-700 mb-8 max-w-lg">
                Komplexní leadership program pro firmy a organizace
              </p>
              ...
              <div className="reveal reveal-delay-600">
                <button
                  onClick={() => navigate('/rezervace', { state: { program: 'Pro firmy - Leadership' } })}
               ...
               <div className="group relative bg-white rounded-2xl shadow-lg overflow-hidden border border-[#21435F] reveal transition-all duration-300 hover:shadow-xl z-10 flex flex-col self-start">
                 ...
                 <div className="p-8 flex flex-col">
                   ...
                   <p className="text-lg text-gray-700 mb-6 font-['Montserrat'] leading-relaxed">
                     Leadership program je komplexní řešení pro firmy a organizace, které chtějí rozvíjet leadership dovednosti a budovat silný tým. 
                     Společně vytvoříme strategii, která pomůže Vaší firmě růst a dosahovat lepších výsledků.
                   </p>
                   <ul className="space-y-3">
                     ...
                     <div className="flex gap-4">
                       ...
                       <div>
                         ...
                         <p className="text-base text-gray-700 font-['Montserrat'] leading-relaxed">
                           Společně probereme potřeby Vaší firmy, aktuální situaci a cíle. Tato analýza nám pomůže vytvořit individuální plán leadership programu.
                         </p>
                       </div>
                     </div>
                     <div className="flex gap-4">
                       ...
                       <div>
                         ...
                         <p className="text-base text-gray-700 font-['Montserrat'] leading-relaxed">
                           Pravidelná sezení zaměřená na rozvoj leadership dovedností, vedení týmu a strategické plánování.
                         </p>
                       </div>
                     </div>
                     <div className="flex gap-4">
                       ...
                       <div>
                         ...
                         <p className="text-base text-gray-700 font-['Montserrat'] leading-relaxed">
                           Interaktivní workshopy a školení pro vedení a týmy zaměřené na praktické dovednosti a budování silné firemní kultury.
                         </p>
                       </div>
                     </div>
                     <div className="flex gap-4">
                       ...
                       <div>
                         ...
                         <p className="text-base text-gray-700 font-['Montserrat'] leading-relaxed">
                           Průběžná podpora, konzultace a úpravy strategie podle potřeb Vaší firmy a dosažených výsledků.
                         </p>
                       </div>
                     </div>
                   </div>
